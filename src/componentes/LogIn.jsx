...
const LogIn = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // 👇 Aquí redirige al inicio al darle click
    navigate('/inicio');
  };
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="relative">
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full bg-black/50 border border-zinc-700 focus:border-cyan-400 text-cyan-50 font-bold tracking-wider p-3 outline-none transition-all duration-300 shadow-[inset_0_0_10px_rgba(0,0,0,0.8)] focus:shadow-[0_0_15px_rgba(6,182,212,0.4)] placeholder-zinc-600"
                placeholder="INGRESE_USUARIO"
              />
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={handleChange}
              required
              className="w-full bg-black/50 border border-zinc-700 focus:border-fuchsia-500 text-fuchsia-50 font-bold tracking-widest p-3 outline-none transition-all duration-300 shadow-[inset_0_0_10px_rgba(0,0,0,0.8)] focus:shadow-[0_0_15px_rgba(217,70,239,0.4)] placeholder-zinc-600"
              placeholder="••••••••"
            />
          </div>
