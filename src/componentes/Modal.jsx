...
function Modal() {
    ...
    const todasLasPeliculas = [...state.Populares, ...state.Accion, ...state.Comedia, ...state.Terror, ...state.Animadas];
...
{video?.key ? (
  <div className="aspect-video w-full overflow-hidden rounded-lg">
    <iframe src={`https://www.youtube.com/embed/${video.key}`}className="h-full w-full" frameBorder="0"  allowFullScreen title={pelicula.title} ></iframe>
