    ...
    <div className="relative mx-auto ">
      ...
      <div ref={scrollRef} className="listaP overflow-visible">
        {state.Accion.map((item) => (
          <div
            key={item.id} className="min-w-[260px] shrink-0 overflow-hidden rounded-2xl bg-zinc-900 shadow-lg ring-1 ring-white/80 transform transition-all duration-300 hover:z-20 hover:-translate-y-4 hover:scale-105 hover:shadow-2xl hover:ring-red-500/50">
